...
public class SQLDatabase {
	...
	//Fields for the SQLDatabase object setting up a connection and statement objects to properly use SQL commands
	private Connection curConection = null;
	private Statement curStatement = null;
	private ResultSet queryResult = null;
	private Random rand = new Random();
	
	//Constructor sets the connection to the database TriviQuestionsDB
	public SQLDatabase() {
		try {
	...
	//adds a Multiple choice tuple to the MultipleChoice table in the current database ADMIN USE ONLY
